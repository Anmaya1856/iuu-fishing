# -*- coding: utf-8 -*-
"""Identify_Ocean_False_Values.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1o0bcK7FgX8HA8UaEJnt5JC_VI7uaRkAv
"""
...
df = pd.read_csv("all_false.csv")
print(df.head())

with open('eastBering.json') as f:
    bering = geojson.load(f)
...
def identify_ocean(longitude, latitude):
    ...
    # for feature in bering['features']:
    #   print("hi")
    #   print(len(feature['geometry']['coordinates']))
    #   if Point(point).within(Polygon(feature['geometry']['coordinates'][1][0])):
    #     print("bering")
    #     ocean_list.append("bering")
    ...
    for feature in pacific['features']:
        for x in range(len(feature['geometry']['coordinates'])):
          if Point(point).within(Polygon(feature['geometry']['coordinates'][x][0])):
              # print("pacific")
...
# temp = identify_ocean(-164.7754667,55.76456)
# print(temp)
...
df.to_csv("exact_name_8.csv")

from google.colab import files
files.download("ocean_list_8.csv")
files.download("exact_name_8.csv")